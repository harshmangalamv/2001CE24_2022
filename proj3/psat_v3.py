...
if tch == 1:
    corr = st.number_input("Enter thresold value C:", value = 0, step=1)
    # corr = int(input('Enter thresold value C:'))
elif tch == 2:
    SNR = st.number_input("Enter thresold value S:", value = 0, step=1)
    # SNR = int(input('Enter thresold value S:'))
elif tch == 3:
    Lambda = st.number_input("Enter Lambda value for A:", value = 0.00, step=0.01, format='%.2f')
    k = st.number_input("Enter k value A:", value = 0.00, step=0.01, format='%.2f')
    ...
    corr = st.number_input("Enter thresold value C:", value=0, step=1)
    Lambda = st.number_input("Enter thresold value A:", value = 0.00, step=0.01, format='%.2f')
    k = st.number_input("Enter k value for A:", value = 0.00, step=0.01, format='%.2f')
    # corr = int(input('Enter thresold value C:'))
    # Lambda = float(input('Enter Lambda value for A:'))
    # k = float(input('Enter k value for A:'))
elif tch == 6:
    SNR = st.number_input("Enter thresold value for S:", value=0, step=1)
    Lambda = st.number_input("Enter thresold value A:", value = 0.00, step=0.01, format='%.2f')
    k = st.number_input("Enter k value for A:", value=0.00,
                        step=0.01, format='%.2f')
    # SNR = int(input('Enter thresold value S:'))
    # Lambda = float(input('Enter Lambda value for A:'))
    # k = float(input('Enter k value for A:'))
...
st.write('5. Mean of Previous 2 Points')
st.write( '6. All Seqential')
st.write('7. All Parallel')
# st.write('1. previous point','2. 2*last-2nd_last','3. overall_mean',
...
#       '4. 12_point_strategy','5. mean of previous 2 point',
#       '6. all seqential','7. all parallel',sep='\n')
sch = st.number_input('Chose Replacement Method From Above:', value= 0, step=1)
